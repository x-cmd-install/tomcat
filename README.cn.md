...
[![x-cmd/install — tomcat Code Quality Monitoring Repo Card](https://x-cmd.com/repo-card/tomcat.svg?lang=zh)](https://x-cmd.com/install/tomcat)
...
合计: **452,640** 行代码（覆盖前 5 种语言、共 **3178** 个文件）。
...
- **Star**: 8,255 · **Fork**: 5,399 · **开放 issue**: 0 · **贡献者**: 163

## 累计统计

- **发布数**: 0 · **已合并 PR**: 322 · **开放 PR**: 45 · **已关闭 issue**: 0 · **开放 issue**: 0 · **提交数**: 29105
...
_数据快照: `data/card/260925.yml` · 2026-09-25T05:17:47Z._
